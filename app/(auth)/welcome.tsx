            ...
            <AnimatedButton onPress={() => router.push("/(auth)/login")}>
              <View style={styles.secondaryButton}>
                <View style={styles.btnIconSectionDark}>
                  <Ionicons name="log-in" size={24} color="#818CF8" />
                </View>
                <View style={styles.btnDividerDark} />
                <View style={styles.btnTextSection}>
                  <Text style={styles.btnTitleSecondary}>Already have an account</Text>
                  <Text style={styles.btnSubSecondary}>Sign in to your account</Text>
                </View>
